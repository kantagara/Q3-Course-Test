...
public class MarketplaceBrowser : MonoBehaviour
{
    ...
    private async void OnDestroy()
    {
        if (_marketplaceContract != null)
            await _marketplaceContract.DisposeAsync();
    }
    ...
    private async void Awake()
    {
        ...
        try
        {
            _marketplaceContract =
                await Web3Unity.Web3.ContractBuilder.Build<MarketplaceContract>(marketplaceContractAddress);
    ...
    private void ItemSold(MarketplaceContract.ItemSoldEventDTO obj)
    {
        ...
        IMainThreadRunner mainThreadRunner = (IMainThreadRunner)Web3Unity.Web3.ServiceProvider.GetService(typeof(IMainThreadRunner));

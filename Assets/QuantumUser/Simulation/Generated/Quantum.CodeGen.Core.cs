...
namespace Quantum {
  ...
  public unsafe partial struct CircleStateUnion {
    ...
    public const Int32 COOLDOWNSTATE = 3;
    public const Int32 SHRINKSTATE = 4;
    public Int32 Field {
      get {
        return _field_used_;
      }
  ...
  public unsafe partial struct PickupItem : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + PickupItemConfigBase.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PickupItem*)ptr;
        AssetRef.Serialize(&p->PickupItemConfigBase, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct SpawnPointList : Quantum.IComponentSingleton {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    ...
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.SpawnPointList*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (SpawnPointList*)ptr;
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentRemoved<Quantum.SpawnPointList>();
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.SpawnPointList), Quantum.SpawnPointList.SIZE);

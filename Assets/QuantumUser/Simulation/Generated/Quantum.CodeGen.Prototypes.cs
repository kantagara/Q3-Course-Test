...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.LootDrop))]
  public unsafe partial class LootDropPrototype : ComponentPrototype<Quantum.LootDrop> {
    public AssetRef<EntityPrototype> HealthLoot;
    public AssetRef<EntityPrototype> WeaponLoot;
    partial void MaterializeUser(Frame frame, ref Quantum.LootDrop result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.LootDrop component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.LootDrop result, in PrototypeMaterializationContext context = default) {
        result.HealthLoot = this.HealthLoot;
        result.WeaponLoot = this.WeaponLoot;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe class PickupItemPrototype : ComponentPrototype<Quantum.PickupItem> {
    ...
    public AssetRef<PickupItemConfigBase> PickupItemConfigBase;
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
    ...
    public void Materialize(Frame frame, ref Quantum.PickupItem result, in PrototypeMaterializationContext context = default) {
        ...
        result.PickupItemConfigBase = this.PickupItemConfigBase;
    }
  }
  [System.SerializableAttribute()]

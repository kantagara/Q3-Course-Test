...
namespace ChainSafe.Gaming.UnityPackage
{
    ...
    public class Web3Unity : MonoBehaviour, IWeb3InitializedHandler
    {
        ...
        public async Task StartTokenStreaming()
        {
            /*await _forwarder.CreatePool("0xC5FCF18Dc1CD147f5Ad3a95210cc61Cb024C5Bf1",
                "0xb4aa2EAdd382Def28d20a7d12966FA64b768e56F",, BigInteger.Pow(10, 12), Array.Empty<byte>());*/
        }
        
        public async Task StopTokenStreaming()
        {
            /*await _forwarder.DeleteFlow("0x0a3b51b581e61c297E07De01A35835DED311F98B",
                "0xb4aa2EAdd382Def28d20a7d12966FA64b768e56F", _web3.Signer.PublicAddress, Array.Empty<byte>());*/
        }
    }
}